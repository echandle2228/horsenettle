...
Min_lmer1 <- lmer(ctmin ~ location + (1|ID), data = bilin)

Anova(Min_lmer1, type="III")

postHocs <- glht(Min_lmer1, linfct = mcp(location = "Tukey"))
summary(postHocs)



Max_lmer1 <- lmer(ctmax ~ location + (1|ID), data = bilin)

Anova(Max_lmer1, type="III")

postHocs <- glht(Max_lmer1, linfct = mcp(location = "Tukey"))
summary(postHocs)



opt_lmer1 <- lmer(topt ~ location + (1|ID), data = bilin)

Anova(opt_lmer1, type="III")

postHocs <- glht(opt_lmer1, linfct = mcp(location = "Tukey"))
summary(postHocs)
