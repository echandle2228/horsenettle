...
CCMS_lmer1 <- lmer(CMS ~ location + (1|ID), data = C.CMS)

Anova(CCMS_lmer1, type="III")

postHocs <- glht(CCMSL_lmer1, linfct = mcp(ramet = "Tukey"))
summary(postHocs)



CCMS_lmer2 <- lmer(CMS ~ ramet, data = C.CMS)

Anova(CCMS_lmer2, type="III")

postHocs <- glht(CCMSL_lmer2, linfct = mcp(ramet = "Tukey"))
summary(postHocs)
