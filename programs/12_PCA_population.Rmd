...
(PCA.p1 <- autoplot(prcomp(data.nona[,c(7:12)], center = TRUE, scale. = TRUE), 
         data = data.nona, colour = 'population', 
         loadings = TRUE, 
  ...
  scale_fill_manual(values = c("#0000CD", "#66CD00", "#EE2C2C", "#FF7F00", "#79CDCD")) +
  scale_color_manual(values = c("#0000CD", "#66CD00", "#EE2C2C", "#FF7F00", "#79CDCD")) +
  xlim(-0.4,0.4) +
  ylim(-0.4,0.4) +
  HStheme())

# Saving graph
ggsave("figures/PCA1_pop.png", width = 7, height = 5, dpi = 300)
...
# Saving graph
ggsave("figures/PCA2_pop.png", width = 7, height = 5, dpi = 300)
...
# Saving graph
ggsave("figures/PCA3_pop.png", width = 7, height = 5, dpi = 300)
