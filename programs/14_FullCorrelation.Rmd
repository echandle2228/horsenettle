...
padj <- apply(p.mat, 2, p.adjust, method = "holm")
padj


adjust.corr(p.mat, type = "pearson", adjust = "holm")


Corr <- corrplot(correlation,type="lower", tl.srt = 45,
                 p.mat = p.mat, sig.level = 0.05, insig = "blank", number.cex = 0.8,
                 addCoef.col ='black', tl.col = c("#104E8B", "#104E8B", "#104E8B", "#104E8B", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222"))


Corr <- corrplot(correlation,type="lower", tl.srt = 45,
                 p.mat = padj, sig.level = 0.05, insig = "blank", number.cex = 0.8,
                 addCoef.col ='black', tl.col = c("#104E8B", "#104E8B", "#104E8B", "#104E8B", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222"))
...
# Adjusted p-values with bonferroni correction
padj_N <- apply(p.mat_N, 2, p.adjust, method = "holm")
padj_N

Corr1 <- corrplot(North ,type="lower", tl.srt = 45,
                 p.mat = padj_N, sig.level = 0.05, insig = "blank", number.cex = 0.8,
                 addCoef.col ='black', tl.col = c("#104E8B", "#104E8B", "#104E8B", "#104E8B", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222"))
...
# Adjusted p-values with bonferroni correction
padj_S <- apply(p.mat_S, 2, p.adjust, method = "holm")
padj_S

Corr2 <- corrplot(South ,type="lower", tl.srt = 45,
                 p.mat = padj_S, sig.level = 0.05, insig = "blank", number.cex = 0.8,
                 addCoef.col ='black', tl.col = c("#104E8B", "#104E8B", "#104E8B", "#104E8B", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222", "#B22222"))
