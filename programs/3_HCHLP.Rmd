...
HCHPL.origin <- lmer(treatment_initial ~ location + (1|ramet) + (1|population), data = H.CHPL)
...
(H.CHPL.p1 <- ggplot(H.CHPL, aes(x = location, CHPL, fill = location)) + 
    ...
    labs(x = "Region", y = "Chlorophyll Ratio", title = "Chlorophyll Fluorescence", subtitle = "Hot Treatment")+
    HStheme() +
