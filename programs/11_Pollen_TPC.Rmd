...
## Single plant with plot - Germination
...
ggsave("figures/germ_curve_N.png", width = 7, height = 5, dpi = 300)
...
(OP1A.p <- ggplot(single, aes(temp,germ)) +
  ...
  HStheme() +
  labs(x = "Temperature (ºC)", y = '% Germination',
       title = "OP1 A"))

ggsave("figures/germ_curve_S.png", width = 7, height = 5, dpi = 300)
...
# Plot data and model fit
(PI1A.p <- ggplot(single, aes(temp,PTGR)) +
  geom_point() +
  geom_line(aes(temp, .fitted), preds_PI, col = 'blue') +
  HStheme() +
  labs(x = 'Temperature (ºC)',
...
ggsave("figures/PTGR_curve_N.png", width = 7, height = 5, dpi = 300)
...
# Plot data and model fit
(OP1A.p <- ggplot(single, aes(temp,PTGR)) +
  geom_point() +
  geom_line(aes(temp, .fitted), preds_OP, col = 'red') +
  HStheme() +
  labs(x = "Temperature (ºC)", y = 'PTGR',
       title = "OP1 A"))

ggsave("figures/PTGR_curve_S.png", width = 7, height = 5, dpi = 300)
